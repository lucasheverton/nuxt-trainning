  ...
  async asyncData({ store }) {
    return {
      categories: await store.dispatch('categories/getCategories')
        .then(res => res.map(obj => ({...obj, is_updating: false })))
    }
  },

  methods: {
    deleteCategory(id) {
      return this.$store.dispatch('categories/deleteCategory', id)
        .then(() => {
    ...
    updateCategory(category) {
      ...
      return this.$store.dispatch('categories/updateCategory', { id: category.id, data })
